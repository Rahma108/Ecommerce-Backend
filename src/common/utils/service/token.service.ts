...
export class TokenService { 
    ...
    this.ACCESS_EXPIRES_IN = Number(this.configService.get('ACCESS_EXPIRES_IN'));
    this.REFRESH_EXPIRES_IN = Number(this.configService.get('REFRESH_EXPIRES_IN'));
    this.System_REFRESH_TOKEN_SECURITY_KEY= this.configService.get("System_REFRESH_TOKEN_SECURITY_KEY") as string
     this.System_TOKEN_SECURITY_KEY= this.configService.get("System_TOKEN_SECURITY_KEY") as string
     this.User_REFRESH_TOKEN_SECURITY_KEY = this.configService.get("User_REFRESH_TOKEN_SECURITY_KEY") as string
    this.User_TOKEN_SECURITY_KEY = this.configService.get("User_TOKEN_SECURITY_KEY") as string
    }
...
async getTokenSignatureLevel (level : RoleEnum ) : Promise<{accessSignature: string , refreshSignature: string }>{
    ...
    switch (level) {
        case RoleEnum.ADMIN:
        signatureLevel = {accessSignature : this.System_TOKEN_SECURITY_KEY , refreshSignature  : this.System_REFRESH_TOKEN_SECURITY_KEY};
        break;
        default:
            signatureLevel = {accessSignature : this.User_TOKEN_SECURITY_KEY, refreshSignature  : this.User_REFRESH_TOKEN_SECURITY_KEY};
        break;
    }
